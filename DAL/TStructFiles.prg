...
// справочник учреждений
	...
	aEtalonDB :=	{ ;
					...
					{ 'ADDRESS',   'C', 70, 0}, ; // адрес нахождения учреждения
...
// справочник _mo_ovmp
	cClassName := Upper( 'T_MO_OVMP' )
	cName := exe_dir + '_mo_ovmp' + sdbf
	aEtalonDB := 	{ ;
					{ 'KOD',		'C',   10, 0 }, ;
					{ 'METOD',		'N',	3, 0 }, ;
					{ 'ID',			'C',   10, 0 }, ;
	...
	cAlias := '_MO_OVMP'
	aIndex := { ;
		{ cur_dir + '_mo_ovmp', 'str( metod, 3 )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник mo_ovmp' ) )
//---------
...
// справочник _mo_prof
	cClassName := Upper( 'T_MO_PROFDB' )
	cName := exe_dir + '_mo_prof' + sdbf
	aEtalonDB := 	{ ;
					{ 'SHIFR',		'C',   20, 0 }, ;
					{ 'VZROS_REB',	'N',	1, 0 }, ;
					{ 'PROFIL',		'N',	3, 0 } ;
	...
	cAlias := '_MO_PROF'
	aIndex := { ;
		{ cur_dir + '_mo_prof', 'shifr + str( vzros_reb, 1 ) + str( profil, 3 )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo_prof' ) )
//---------

// справочник _mo_prprk
	cClassName := Upper( 'T_MO_PRPRKDB' )
	cName := exe_dir + '_mo_prprk' + sdbf
	aEtalonDB := 	{ ;
					{ 'PROFIL_K',	'N',	3, 0 }, ;
					{ 'VOZR',		'C',	1, 0 }, ;
					{ 'POL',		'C',	1, 0 }, ;
	...
	cAlias := '_MO_PRPRK'
	aIndex := { ;
		{ cur_dir + '_mo_prprk', 'str( profil, 3 ) + str( profil_k, 3 )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo_prprk' ) )
//---------
...
// справочник _mo_spec
	cClassName := Upper( 'T_MO_SPECDB' )
	cName := exe_dir + '_mo_spec' + sdbf
	aEtalonDB := 	{ ;
					{ 'SHIFR',		'C',   20, 0 }, ;
					{ 'VZROS_REB',	'N',	1, 0 }, ;
					{ 'PRVS',		'N',	6, 0 }, ;
	...
	cAlias := '_MO_SPEC'
	aIndex := { ;
		{ cur_dir + '_mo_spec', 'shifr + str( vzros_reb, 1 ) + str( prvs_new, 6 )' }, ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo_spec' ) )
//---------

// справочник T005
	cClassName := Upper( 'T_T005DB' )
	cName := exe_dir + '_mo_t005' + sdbf
	aEtalonDB := 	{ ;
					{ 'KOD',		'N',	3, 0 }, ;
					{ 'NAME',		'C',  132, 0 } ;
					}
	cAlias := '_MO_T005'
	aIndex := { ;
		{ cur_dir + '_mo_t005', 'str( kod, 3 )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник T005' ) )
//---------

// справочник T006
	cClassName := Upper( 'T_T006DB' )
	cName := exe_dir + '_mo_t006' + sdbf
	aEtalonDB := 	{ ;
					{ 'TYPE_KSG',	'N',	1, 0 }, ;
					{ 'R0',			'N',	1, 0 }, ;
					{ 'R1',			'N',	1, 0 }, ;
	...
	cAlias := '_MO_T006'
	aIndex := { ;
		{ cur_dir + '_mo_t006', 'str( type_ksg, 1 ) + name' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник T006' ) )
//---------

// справочник T007
	cClassName := Upper( 'T_T007DB' )
	cName := exe_dir + '_mo_t007' + sdbf
	aEtalonDB := 	{ ;
					{ 'PROFIL_K',	'N',	3, 0 }, ;
					{ 'PROFIL',		'N',	3, 0 }, ;
					{ 'NAME',		'C',  255, 0 } ;
	...
	cAlias := '_MO_T007'
	aIndex := { ;
		{ cur_dir + '_mo_t007', 'str( profil_k, 3 ) + str( profil, 3 )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник T007' ) )
//---------

// справочник учётных единиц объёма
	cClassName := Upper( 'T_MO_UNITDB' )
	cName := exe_dir + '_mo_unit' + sdbf
	aEtalonDB := 	{ ;
					{ 'CODE',		'N',	3, 0 }, ;
					{ 'PZ',			'N',	2, 0 }, ;
					{ 'II',			'N',	2, 0 }, ;
	...
	cAlias := '_MO_UNIT'
	aIndex := { ;
		{ cur_dir + '_mo_unit', 'str( code, 3 )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник учётных единиц объёма' ) )
//---------

// справочники для онкологии
//
// справочник N001
	cClassName := Upper( 'T_N001DB' )
	cName := exe_dir + '_mo_N001' + sdbf
	aEtalonDB := 	{ ;
					{ 'ID_PROT',	'N',	1, 0 }, ;
					{ 'PROT_NAME',	'C',  250, 0 }, ;
					{ 'DATEBEG',	'D',	8, 0 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник N001' ) )
//---------

// справочник N002
	cClassName := Upper( 'T_N002DB' )
	cName := exe_dir + '_mo_N002' + sdbf
	aEtalonDB := 	{ ;
					{ 'ID_ST',		'N',	4, 0 }, ;
					{ 'DS_ST',		'C',	5, 0 }, ;
					{ 'KOD_ST',		'C',	5, 0 }, ;
	...
	cAlias := '_MO_N002'
	aIndex := { ;
		{ cur_dir + '_mo_N002', 'str( id_st, 6 )' }, ;
		{ cur_dir + '_mo_N002d', 'ds_st + kod_st' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник N002' ) )
//---------

// справочник N003
	cClassName := Upper( 'T_N003DB' )
	cName := exe_dir + '_mo_N003' + sdbf
	aEtalonDB := 	{ ;
					{ 'ID_T',		'N',	4, 0 }, ;
					{ 'DS_T',		'C',	5, 0 }, ;
					{ 'KOD_T',		'C',	5, 0 }, ;
	...
	cAlias := '_MO_N003'
	aIndex := { ;
		{ cur_dir + '_mo_N003', 'str( id_t, 6 )' }, ;
		{ cur_dir + '_mo_N003d', 'ds_t + kod_t' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник N003' ) )
//---------

// справочник N004
	cClassName := Upper( 'T_N004DB' )
	cName := exe_dir + '_mo_N004' + sdbf
	aEtalonDB := 	{ ;
					{ 'ID_N',		'N',	4, 0 }, ;
					{ 'DS_N',		'C',	5, 0 }, ;
					{ 'KOD_N',		'C',	5, 0 }, ;
	...
	cAlias := '_MO_N004'
	aIndex := { ;
		{ cur_dir + '_mo_N004', 'str( id_n, 6 )' }, ;
		{ cur_dir + '_mo_N004d', 'ds_n + kod_n' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник N004' ) )
//---------

// справочник N005
	cClassName := Upper( 'T_N005DB' )
	cName := exe_dir + '_mo_N005' + sdbf
	aEtalonDB := 	{ ;
					{ 'ID_M',		'N',	4, 0 }, ;
					{ 'DS_M',		'C',	5, 0 }, ;
					{ 'KOD_M',		'C',	5, 0 }, ;
	...
	cAlias := '_MO_N005'
	aIndex := { ;
		{ cur_dir + '_mo_N005', 'str( id_m, 6 )' }, ;
		{ cur_dir + '_mo_N005d', 'ds_m + kod_m' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник N005' ) )
//---------

// справочник N006
	cClassName := Upper( 'T_N006DB' )
	cName := exe_dir + '_mo_N006' + sdbf
	aEtalonDB := 	{ ;
					{ 'ID_GR',		'N',	4, 0 }, ;
					{ 'DS_GR',		'C',	5, 0 }, ;
					{ 'ID_ST',		'N',	4, 0 }, ;
	...
	cAlias := '_MO_N006'
	aIndex := { ;
		{ cur_dir + '_mo_N006', 'ds_gr + str( id_t, 6 ) + str( id_n, 6 ) + str( id_m, 6 )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник N006' ) )
//---------

// справочник N007
	cClassName := Upper( 'T_N007DB' )
	cName := exe_dir + '_mo_N007' + sdbf
	aEtalonDB := 	{ ;
					{ 'ID_MRF',		'N',	2, 0 }, ;
					{ 'MRF_NAME',	'C',  250, 0 }, ;
					{ 'DATEBEG',	'D',	8, 0 }, ;
	...
	cAlias := '_MO_N007'
	aIndex := { ;
		{ cur_dir + '_mo_N007', 'str( id_mrf, 6 )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник N007' ) )
//---------

// справочник N008
	cClassName := Upper( 'T_N008DB' )
	cName := exe_dir + '_mo_N008' + sdbf
	aEtalonDB := 	{ ;
					{ 'ID_R_M',		'N',	3, 0 }, ;
					{ 'ID_MRF',		'N',	2, 0 }, ;
					{ 'R_M_NAME',	'C',  250, 0 }, ;
	...
	cAlias := '_MO_N008'
	aIndex := { ;
		{ cur_dir + '_mo_N008', 'str( id_mrf, 6 )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник N008' ) )
//---------

// справочник N009
	cClassName := Upper( 'T_N009DB' )
	cName := exe_dir + '_mo_N009' + sdbf
	aEtalonDB := 	{ ;
					{ 'ID_M_D',		'N',	2, 0 }, ;
					{ 'DS_MRF',		'C',	3, 0 }, ;
					{ 'ID_MRF',		'N',	2, 0 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник N009' ) )
//---------

// справочник N010
	cClassName := Upper( 'T_N010DB' )
	cName := exe_dir + '_mo_N010' + sdbf
	aEtalonDB := 	{ ;
					{ 'ID_IGH',		'N',	2, 0 }, ;
					{ 'KOD_IGH',	'C',  250, 0 }, ;
					{ 'IGH_NAME',	'C',  250, 0 }, ;
	...
	cAlias := '_MO_N010'
	aIndex := { ;
		{ cur_dir + '_mo_N010', 'str( id_igh, 6 )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник N010' ) )
//---------

// справочник N011
	cClassName := Upper( 'T_N011DB' )
	cName := exe_dir + '_mo_N011' + sdbf
	aEtalonDB := 	{ ;
					{ 'ID_R_I',		'N',	3, 0 }, ;
					{ 'ID_IGH',		'N',	2, 0 }, ;
					{ 'KOD_R_I',	'C',  250, 0 }, ;
	...
	cAlias := '_MO_N011'
	aIndex := { ;
		{ cur_dir + '_mo_N011', 'str( id_igh, 6 )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник N011' ) )
//---------

// справочник N012
	cClassName := Upper( 'T_N012DB' )
	cName := exe_dir + '_mo_N012' + sdbf
	aEtalonDB := 	{ ;
					{ 'ID_I_D',		'N',	2, 0 }, ;
					{ 'DS_IGH',		'C',	3, 0 }, ;
					{ 'ID_IGH',		'N',	2, 0 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник N012' ) )
//---------

// справочник N013
	cClassName := Upper( 'T_N013DB' )
	cName := exe_dir + '_mo_N013' + sdbf
	aEtalonDB := 	{ ;
					{ 'ID_TLECH',	'N',	1, 0 }, ;
					{ 'TLECH_NAME',	'C',  250, 0 }, ;
					{ 'DATEBEG',	'D',	8, 0 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник N013' ) )
//---------

// справочник N014
	cClassName := Upper( 'T_N014DB' )
	cName := exe_dir + '_mo_N014' + sdbf
	aEtalonDB := 	{ ;
					{ 'ID_THIR',	'N',	1, 0 }, ;
					{ 'THIR_NAME',	'C',  250, 0 }, ;
					{ 'DATEBEG',	'D',	8, 0 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник N014' ) )
//---------

// справочник N015
	cClassName := Upper( 'T_N015DB' )
	cName := exe_dir + '_mo_N015' + sdbf
	aEtalonDB := 	{ ;
					{ 'ID_TLEK_L',	'N',	1, 0 }, ;
					{ 'TLEK_NAMEL',	'C',  250, 0 }, ;
					{ 'DATEBEG',	'D',	8, 0 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник N015' ) )
//---------

// справочник N016
	cClassName := Upper( 'T_N016DB' )
	cName := exe_dir + '_mo_N016' + sdbf
	aEtalonDB := 	{ ;
					{ 'ID_TLEK_V',	'N',	1, 0 }, ;
					{ 'TLEK_NAMEV',	'C',  250, 0 }, ;
					{ 'DATEBEG',	'D',	8, 0 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник N016' ) )
//---------

// справочник N017
	cClassName := Upper( 'T_N017DB' )
	cName := exe_dir + '_mo_N017' + sdbf
	aEtalonDB := 	{ ;
					{ 'ID_TLUCH',	'N',	1, 0 }, ;
					{ 'TLUCH_NAME',	'C',  250, 0 }, ;
					{ 'DATEBEG',	'D',	8, 0 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник N017' ) )
//---------
//
// конец справочников для онкологии

// справочник _mo_usl
	cClassName := Upper( 'T_MO_USLDB' )
	cName := exe_dir + '_mo_usl' + sdbf
	aEtalonDB := 	{ ;
					{ 'SHIFR',		'C',   10, 0 }, ;
					{ 'NAME',		'C',  255, 0 }, ;
					{ 'USL',		'N',	1, 0 }, ;
	...
	cAlias := '_MO_USL'
	aIndex := { ;
		{ cur_dir + '_mo_usl', 'shifr' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo_usl' ) )
//---------

// справочник _mo_uslc
	cClassName := Upper( 'T_MO_USLCDB' )
	cName := exe_dir + '_mo_uslc' + sdbf
	aEtalonDB := 	{ ;
					{ 'CODEMO',		'C',	6, 0 }, ;
					{ 'SHIFR',		'C',   10, 0 }, ;
					{ 'UROVEN',		'N',	1, 0 }, ;
	...
	cAlias := '_MO_USLC'
	aIndex := { ;
		{ cur_dir + '_mo_uslc', 'shifr + str( uroven, 1 ) + str( vzros_reb, 1 ) + dtos( datebeg )' }, ;
		{ cur_dir + '_mo_uslu', 'codemo + shifr + str( vzros_reb, 1 ) + dtos( datebeg )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo_uslc' ) )
//---------

// справочник _mo_usld
	cClassName := Upper( 'T_MO_USLDDB' )
	cName := exe_dir + '_mo_usld' + sdbf
	aEtalonDB := 	{ ;
					{ 'SHIFR',		'C',   10, 0 }, ;
					{ 'DOPL_F',		'N',   10, 2 }, ;
					{ 'DOPL_R',		'N',   10, 2 }, ;
	...
	cAlias := '_MO_USLD'
	aIndex := { ;
		{ cur_dir + '_mo_usld', 'shifr + dtos( datebeg )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo_usld' ) )
//---------

// справочник _mo_uslf
	cClassName := Upper( 'T_MO_USLFDB' )
	cName := exe_dir + '_mo_uslf' + sdbf
	aEtalonDB := 	{ ;
					{ 'SHIFR',		'C',   20, 0 }, ;
					{ 'NAME',		'C',  255, 0 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo_uslf' ) )
//---------

// справочник _mo_uslz
	cClassName := Upper( 'T_MO_USLZDB' )
	cName := exe_dir + '_mo_uslz' + sdbf
	aEtalonDB := 	{ ;
					{ 'SHIFR',		'C',   10, 0 }, ;
					{ 'KOD_DIAG',	'C',	6, 0 }, ;
					{ 'TYPE_DIAG',	'N',	1, 0 } ;
	...
	cAlias := '_MO_USLF'
	aIndex := { ;
		{ cur_dir + '_mo_uslz', 'shifr + str( type_diag, 1 ) + kod_diag' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo_uslz' ) )
//---------

// справочник _mo5k006
	cClassName := Upper( 'T_MO5K006DB' )
	cName := exe_dir + '_mo5k006' + sdbf
	aEtalonDB := 	{ ;
					{ 'SHIFR',		'C',	7, 0 }, ;
					{ 'KZV',		'N',	5, 2 }, ;
					{ 'KZD',		'N',	5, 2 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo5k006' ) )
//---------

// справочник _mo5t006
	cClassName := Upper( 'T_MO5T006DB' )
	cName := exe_dir + '_mo5t006' + sdbf
	aEtalonDB := 	{ ;
					{ 'SHIFR',		'C',	7, 0 }, ;
					{ 'KZV',		'N',	5, 2 }, ;
					{ 'KZD',		'N',	5, 2 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo5t006' ) )
//---------

// справочник _mo5uslc
	cClassName := Upper( 'T_MO5USLCDB' )
	cName := exe_dir + '_mo5uslc' + sdbf
	aEtalonDB := 	{ ;
					{ 'CODEMO',		'C',	6, 0 }, ;
					{ 'SHIFR',		'C',   10, 0 }, ;
					{ 'UROVEN',		'N',	4, 0 }, ;
	...
	cAlias := '_MO5USLC'
	//	{ cur_dir + '_mo5uslu', 'left( shifr, 2 ) + substr( shifr, 6, 3 )' }, ;
	aIndex := { ;
		{ cur_dir + '_mo5uslc', 'shifr + str( uroven, 1 ) + str( vzros_reb, 1 ) + dtos( datebeg )' }, ;
		{ cur_dir + '_mo5uslu', 'codemo + shifr + str( vzros_reb, 1 ) + dtos( datebeg )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo5uslc' ) )
//---------

// справочник услуги Минздрава РФ (ФФОМС) 2015-2016 // группа файлов
	cClassName := Upper( 'TServiceFFOMS5DB' )
	cName := exe_dir + '_mo5uslf' + sdbf
	aEtalonDB := 	{ ;
					{ 'SHIFR',		'C',	20,	0 }, ; // 
					{ 'NAME',		'C',  255,	0 }, ; // 
					{ 'TIP',		'N',	1,	0 }, ; // 
	...
	cAlias := 'TServiceFFOMS5DB'
	aIndex := { ;
				{ cur_dir + '_mo5uslf', 'shifr' } ;
				}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'Файл справочника услуг ФФОМС 2015-2016' ) )
//---------

// справочник _mo6k006
	cClassName := Upper( 'T_MO6K006DB' )
	cName := exe_dir + '_mo6k006' + sdbf
	aEtalonDB := 	{ ;
					{ 'SHIFR',		'C',	7, 0 }, ;
					{ 'KZV',		'N',	5, 2 }, ;
					{ 'KZD',		'N',	5, 2 }, ;
	...
	cAlias := '_MO6K006'
	aIndex := { ;
				{ cur_dir + '_mo6k006', 'substr( shifr, 1, 1 ) + ds + sy' }, ;
				{ cur_dir + '_mo6k006_', 'substr( shifr, 1, 1 ) + sy + ds' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo6k006' ) )
//---------

// справочник _mo7k006
	cClassName := Upper( 'T_MO7K006DB' )
	cName := exe_dir + '_mo7k006' + sdbf
	aEtalonDB := 	{ ;
					{ 'SHIFR',		'C',	7, 0 }, ;
					{ 'KZV',		'N',	5, 2 }, ;
					{ 'KZD',		'N',	5, 2 }, ;
	...
	cAlias := '_MO7K006'
	aIndex := { ;
				{ cur_dir + '_mo7k006', 'substr( shifr, 1, 1 ) + ds + sy' }, ;
				{ cur_dir + '_mo7k006_', 'substr( shifr, 1, 1 ) + sy + ds' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo7k006' ) )
//---------

// справочник _mo7uslf
	cClassName := Upper( 'T_MO7USLFDB' )
	cName := exe_dir + '_mo7uslf' + sdbf
	aEtalonDB := 	{ ;
					{ 'SHIFR',		'C',	20,	0 }, ; // 
					{ 'NAME',		'C',  255,	0 }, ; // 
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo7uslf' ) )
//---------

// справочник _mo8dep
	cClassName := Upper( 'T_mo8depDB' )
	cName := exe_dir + '_mo8dep' + sdbf	// класс создан
	aEtalonDB := 	{ ;
					{ 'CODEM',		'C',	6, 0 }, ;
					{ 'MCODE',		'C',	6, 0 }, ;
					{ 'CODE',		'N',	3, 0 }, ;
	...
	cAlias := '_MO8DEP'
	aIndex := { ;
				{ cur_dir + '_mo8dep', 'str( code, 3 )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo8dep' ) )
//---------

// справочник _mo8deppr
	cClassName := Upper( 'T_mo8depprDB' )	// класс создан
	cName := exe_dir + '_mo8deppr' + sdbf
	aEtalonDB := 	{ ;
					{ 'CODEM',		'C',	6, 0 }, ;
					{ 'MCODE',		'C',	6, 0 }, ;
					{ 'CODE',		'N',	3, 0 }, ;
	...
	cAlias := '_MO8DEPPR'
	aIndex := { ;
				{ cur_dir + '_mo8deppr', 'str( code, 3 ) + str( pr_mp, 3 )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo8deppr' ) )
//---------

// справочник _mo8it
	cClassName := Upper( 'T_mo8itDB' )
	cName := exe_dir + '_mo8it' + sdbf	// класс создан
	aEtalonDB := 	{ ;
					{ 'DS',			'C',	5, 0 }, ;
					{ 'IT',			'N',	1, 0 } ;
					}
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo8it' ) )
//---------

// справочник _mo8k006
	cClassName := Upper( 'T_mo8k006DB' )
	cName := exe_dir + '_mo8k006' + sdbf	// класс создан
	aEtalonDB := 	{ ;
					{ 'SHIFR',		'C',	6, 0 }, ;
					{ 'KZ',			'N',	7, 3 }, ;
					{ 'PROFIL',		'N',	2, 0 }, ;
	...
	cAlias := '_MO8K006'
	aIndex := { ;
				{ cur_dir + '_mo8k006', 'substr( shifr, 1, 1 ) + ds + sy + age + sex + los' }, ;
				{ cur_dir + '_mo8k006_', 'substr( shifr, 1, 1 ) + sy + ds + age + sex + los' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo8k006' ) )
//---------

// справочник _mo8kiro
	cClassName := Upper( 'T_mo8kiroDB' )
	cName := exe_dir + '_mo8kiro' + sdbf	// класс создан
	aEtalonDB := 	{ ;
					{ 'CODE',		'N',	2, 0 }, ;
					{ 'NAME',		'C',   35, 0 }, ;
					{ 'NAME_F',		'C',  255, 0 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo8kiro' ) )
//---------

// справочник _mo8kslp
	cClassName := Upper( 'T_mo8kslpDB' )
	cName := exe_dir + '_mo8kslp' + sdbf	// класс создан
	aEtalonDB := 	{ ;
					{ 'CODE',		'N',	2, 0 }, ;
					{ 'NAME',		'C',   35, 0 }, ;
					{ 'NAME_F',		'C',  255, 0 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo8kslp' ) )
//---------

// справочник _mo8lvlpay
	cClassName := Upper( 'T_mo8lvlpayDB' )
	cName := exe_dir + '_mo8lvlpay' + sdbf	// класс создан
	aEtalonDB := 	{ ;
					{ 'CODEM',		'C',	6, 0 }, ;
					{ 'MCODE',		'C',	6, 0 }, ;
					{ 'USL_OK',		'N',	1, 0 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo8lvlpay' ) )
//---------

// справочник _mo8moserv
	cClassName := Upper( 'T_mo8moservDB' )
	cName := exe_dir + '_mo8moserv' + sdbf	// класс создан
	aEtalonDB := 	{ ;
					{ 'CODEM',		'C',	6, 0 }, ;
					{ 'MCODE',		'C',	6, 0 }, ;
					{ 'SHIFR',		'C',   10, 0 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo8moserv' ) )
//---------

// справочник _mo8prices
	cClassName := Upper( 'T_mo8pricesDB' )
	cName := exe_dir + '_mo8prices' + sdbf	// класс создан
	aEtalonDB := 	{ ;
					{ 'SHIFR',		'C',   10, 0 }, ;
					{ 'VZROS_REB',	'N',	1, 0 }, ;
					{ 'LEVEL',		'C',	5, 0 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo8prices' ) )
//---------

// справочник _mo8shema
	cClassName := Upper( 'T_mo8shemaDB' )
	cName := exe_dir + '_mo8shema' + sdbf	// класс создан
	aEtalonDB := 	{ ;
					{ 'KOD',		'C',   10, 0 }, ;
					{ 'NAME',		'C',   75, 0 }, ;
					{ 'DNI',		'N',	3, 0 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo8shema' ) )
//---------

// справочник _mo8subdiv
	cClassName := Upper( 'T_mo8subdivDB' )
	cName := exe_dir + '_mo8subdiv' + sdbf	// класс создан
	aEtalonDB := 	{ ;
					{ 'CODEM',		'C',	6, 0 }, ;
					{ 'MCODE',		'C',	6, 0 }, ;
					{ 'CODE',		'N',	3, 0 }, ;
	...
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo8subdiv' ) )
//---------

// справочник _mo8unit
	cClassName := Upper( 'T_mo8unitDB' )	// класс создан
	cName := exe_dir + '_mo8unit' + sdbf
	aEtalonDB := 	{ ;
					{ 'CODE',		'N',	3, 0 }, ;
					{ 'PZ',			'N',	2, 0 }, ;
					{ 'II',			'N',	2, 0 }, ;
	...
	cAlias := '_MO8UNIT'
	aIndex := { ;
				{ exe_dir + '_mo8unit', 'str( code, 3 )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo8unit' ) )
//---------

// справочник _mo8usl
	cClassName := Upper( 'T_mo8uslDB' )	// класс создан
	cName := exe_dir + '_mo8usl' + sdbf
	aEtalonDB := 	{ ;
					{ 'SHIFR',		'C',   10, 0 }, ;
					{ 'NAME',		'C',  255, 0 }, ;
					{ 'ST',			'N',	1, 0 }, ;
	...
	cAlias := '_MO8USL'
	aIndex := { ;
				{ exe_dir + '_mo8usl', 'shifr' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo8usl' ) )
//---------

// справочник _mo8uslc
	cClassName := Upper( 'T_mo8uslcDB' )	// класс создан
	cName := exe_dir + '_mo8uslc' + sdbf
	aEtalonDB := 	{ ;
					{ 'CODEMO',		'C',	6, 0 }, ;
					{ 'SHIFR',		'C',   10, 0 }, ;
					{ 'USL_OK',		'N',	1, 0 }, ;
	...
	cAlias := '_MO8USLC'
	aIndex := { ;
				{ exe_dir + '_mo8uslc', 'shifr + str( vzros_reb, 1 ) + str( depart, 3 ) + dtos( datebeg )' }, ;
				{ exe_dir + '_mo8uslu', 'codemo + shifr + str( vzros_reb, 1 ) + str( depart, 3 ) + dtos( datebeg )' } ;
	}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo8uslc' ) )
//---------

// справочник _mo8uslf
	cClassName := Upper( 'T_mo8uslfDB' )	// класс создан
	cName := exe_dir + '_mo8uslf' + sdbf
	aEtalonDB := 	{ ;
					{ 'SHIFR',		'C',	20,	0 }, ;
					{ 'NAME',		'C',  255,	0 }, ;
					{ 'TIP',		'N',	1,	0 }, ;
	...
	cAlias := '_MO8USLF'
	aIndex := { ;
				{ exe_dir + '_mo8uslf', 'shifr' } ;
				}
	hb_hSet( ::hbFiles, cClassName, TDBFile( ):New( cName, aIndex, cAlias, aEtalonDB, 'справочник _mo8uslf' ) )
//---------
...
// справочник human_2
	...
	aEtalonDB := 	{ ;
				...
				{ 'PC1',		'C',	10,	0 }, ; // КСЛП (в 2017 - в первом знаке 1-3 - кол-во стентов в коронарных сосудах)
				{ 'PC2',		'C',	10,	0 }, ; // КИРО
				{ 'PC3',		'C',	10,	0 }, ; // дополнительный критерий
				{ 'PC4',		'C',	10,	0 }, ; // "1-NNNNNNN" (1-ый л/у + ссылка на 2-ой лист) или "2-NNNNNNN" (2-ой л/у + ссылка на 1-ый лист)
				{ 'PC5',		'C',	10,	0 }, ; //
				{ 'PC6',		'C',	10,	0 }, ; //
...
// справочник listinform
//	cClassName := Upper( 'TLISTINFORMDB' )
//	cName := exe_dir + 'listinform' + sdbf
//	aEtalonDB := 	{ ;
//					{ 'ENP',		'C',   16,	0 } ;
//					}
//	cAlias := 'LLISTINFORM'
